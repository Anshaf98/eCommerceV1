    ...
    <div className="aboutUs">
      <div className="aboutUsDiv">
        <div className="aboutUsTop">
          <img
            src="https://images.pexels.com/photos/6960358/pexels-photo-6960358.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt=""
          />
            ...
            <div className="aboutUsBottomTexts">
              ...
              <div className="exploreQuote">
                ...
                <p className="exploreQuoteText">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Possimus modi harum doloribus...
                </p>
              </div>

              <span>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dicta
                ipsam incidunt dolorem earum tempore provident, expedita quia.
              </span>
            </div>
        ...
        <div className="aboutUsImages">
          <div className="aboutUsImage">
            <div className="aboutUsImageTop">
              <img
                src="https://images.pexels.com/photos/262028/pexels-photo-262028.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt=""
              />
        ...
        <div className="aboutUsImagesDiv">
          <div className="aboutUsImgDiv">
            ...
            <span>
              ...
              magnam voluptas illo neque omnis aliquam, molestiae nostrum
              dolorem minus odit officia nesciunt asperiores quia sint
              reiciendis est.
            </span>
            <img
              src="https://images.pexels.com/photos/262028/pexels-photo-262028.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
